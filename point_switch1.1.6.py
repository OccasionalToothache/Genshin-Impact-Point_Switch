...
class PointSwitch:
    ...
    def MainUI(self):
        ...
        self.Rename = Checkbutton(master=self.master, text='是否为点位重命名')
        self.Rename.place(x=180, y=280)
        self.Rename.state(['!alternate'])
        Tooltip(self.Rename, '如果出现点位乱序，则此功能会有帮助', topmost=True)
